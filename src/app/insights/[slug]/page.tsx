...
const ARTICLES = {
    "secondaries-renaissance": {
        ...
        toc: [
            { id: "gp-led", title: "GP-Led Transactions: The Architecture of Modern Secondaries" },
            { id: "pricing", title: "Pricing Dynamics and Discount Rate Normalization" }
        ],
        content: (
            <>
                ...
                <h3 id="gp-led" className="text-2xl font-serif text-white mt-12 mb-6 italic pt-8 scroll-mt-24">GP-Led Transactions: The Architecture of Modern Secondaries</h3>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
                ...
                <h3 id="pricing" className="text-2xl font-serif text-white mt-12 mb-6 italic pt-8 scroll-mt-24">Pricing Dynamics and Discount Rate Normalization</h3>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
    ...
    "vc-ai": {
        ...
        toc: [
            { id: "infrastructure", title: "The Infrastructure Layer: Necessary but Not Sufficient" },
            { id: "defensibility", title: "Defensibility and the Data Moat Thesis" }
        ],
        content: (
            <>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
                ...
                <h3 id="infrastructure" className="text-2xl font-serif text-white mt-12 mb-6 italic pt-8 scroll-mt-24">The Infrastructure Layer: Necessary but Not Sufficient</h3>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
                ...
                <h3 id="defensibility" className="text-2xl font-serif text-white mt-12 mb-6 italic pt-8 scroll-mt-24">Defensibility and the Data Moat Thesis</h3>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
    ...
    "infrastructure-core": {
        ...
        toc: [
            { id: "digital-infra", title: "Digital Infrastructure: The Convergence of Technology and Real Assets" },
            { id: "supply-chain", title: "Supply Chain Deglobalization and Industrial Reshoring" }
        ],
        content: (
            <>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
                ...
                <h3 id="digital-infra" className="text-2xl font-serif text-white mt-12 mb-6 italic pt-8 scroll-mt-24">Digital Infrastructure: The Convergence of Technology and Real Assets</h3>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
                ...
                <h3 id="supply-chain" className="text-2xl font-serif text-white mt-12 mb-6 italic pt-8 scroll-mt-24">Supply Chain Deglobalization and Industrial Reshoring</h3>
                <p className="mb-6 text-gray-300 leading-relaxed text-lg">
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    >
                        ...
                        <div className="prose prose-invert prose-lg max-w-none">
                            {('toc' in article && article.toc) && (
                                <div className="border border-white/10 rounded-xl p-6 mb-12 bg-graf-charcoal/30">
                                    <h4 className="text-sm text-gray-400 font-sans tracking-[0.1em] mb-4 uppercase">Table of Contents</h4>
                                    <ul className="space-y-4 m-0 list-none p-0">
                                        {(article.toc as any).map((item: any) => (
                                            <li key={item.id} className="p-0 m-0 border-b border-white/5 pb-2 last:border-0 last:pb-0">
                                                <a href={`#${item.id}`} className="text-base text-gray-300 hover:text-graf-gold transition-colors font-sans no-underline block">
                                                    {item.title}
                                                </a>
                                            </li>
                                        ))}
